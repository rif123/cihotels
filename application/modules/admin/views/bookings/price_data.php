													...
													?>
															<tr>
																...
																<td align="right">
																	...
																	<?php echo checkCategoryBooking(rate_exchange($val['price'])) ?>
																</td>
																<?php if($val['add_person'] > 0){?>
																<td align="center">
																<?php echo $val['add_person']; ?> &times; 
																 <?php echo $this->session->userdata('currency_sybmol'); ?> 
																 <?php echo rate_exchange($val['add_person_price']); ?> =	
																 <?php echo rate_exchange($val['add_person_price']*$val['add_person']); ?></td>
																	<td>  <?php echo $this->session->userdata('currency_sybmol'); ?> 
																		<?php echo rate_exchange($val['price']	+ $val['add_person_price']*$val['add_person'])?></td>
																<?php } ?>
