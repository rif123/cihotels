        ...
        <div id="responsiveTabsDemo">
				  ...
				  <div class="row invoice-info">
					...
					<div class="col-sm-4 invoice-col">
							<table width="90%">
								<tr>
									<th><b><?php echo lang('building')?></b></th>
									<th>:</th>
								...
								<tr>
									<th><b>Kategori :</b></th>
									<th>:</th>
									<td><?php echo $getCategory->nameCategory; ?></td>
								</tr>
								<tr>
									<th><b>Keterangan :</b></th>
									<th>:</th>
									<td><?php echo $booking->kegiatan; ?></td>
								</tr>
										...
										<select name="room_id" class="form-control">
											...
											<?php foreach($rooms as $room){?>
												<option value="<?php echo $room->id?>" 
													<?php echo (@$order_room->room_id==$room->id)?'selected="selected"':''; ?>>
													<?php echo $room->room_no; ?> - <?php echo $room->floor?>
												</option>
											<?php } ?>
										</select>
