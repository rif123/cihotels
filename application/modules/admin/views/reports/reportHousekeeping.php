...
<section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><?php echo lang('expenses_report'); ?></li>
          </ol>
</section>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title"><?php echo lang('expenses_report'); ?></h3>
                </div><!-- /.box-header -->
                <div class="box-body">
					<form method="post" class="formHouseKeeping">
					...
					<div id="responsiveTabsDemo">
						...
						<div id="tab-4">
							<div class="form-group">
							  <div class="row">
								<div class="col-md-4">
									<input type="text" name="from" class="form-control datepickerNew" placeholder="<?php echo lang('date_from')?>" autocomplete="off" value="<?php echo @$_POST['from']?>" />
								</div>
								<div class="col-md-4">
									<input type="text" name="to" class="form-control datepickerNew" placeholder="<?php echo lang('date_to')?>" autocomplete="off" value="<?php echo @$_POST['to']?>"/>
								</div>		
							  </div>		
							</div>
...
var chart = AmCharts.makeChart("weekchart", {
  ...
  "valueAxes": [{
    "axisAlpha": 0,
    "position": "left",
    "title": "<?php echo lang('expenses_report')?>"
  }],
  "startDuration": 1,
  "graphs": [{
