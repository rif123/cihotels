...
<section class="content-header">
          ...
          <ol class="breadcrumb">
			...
			<li class="active"><?php echo (empty($seg))?'Add':'Update';?></li>
          </ol>
</section>
		...
		<tr id="banners-<?php echo $banner->id;?>">
			...
			<td>
				<div class="btn-group" style="float:right">
					...
					<a class="btn btn-danger" href="<?php echo  site_url('admin/banners/delete/'.$banner->id);?>" onclick="return areyousure(this);"><i class="icon-trash icon-white"></i> <?php echo lang('delete');?></a>
				</div>
			</td>
		</tr>
	<?php endforeach; ?>
